...
COPY src /usr/src/urban/
WORKDIR /usr/src/urban
...
RUN chmod +x /usr/src/urban/tasks.py \
    && chmod +x /usr/src/urban/entrypoint.sh
...
# ENTRYPOINT /usr/src/urban/entrypoint.sh
